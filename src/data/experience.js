export const experienceRoles = [
  {
    ...
    focusAreas: ['Dashboard Development', 'Data Visualization', 'Video Editing', 'Deployment'],
    id: 'dost-region-ii',
    initials: 'DO',
    isCurrent: false,
    ...
    responsibilities: [
      ...
      'Collaborated with stakeholders to gather requirements and align product features with operational workflows.',
      'Produced and edited promotional videos, event documentation, and multimedia content for DOST initiatives.',
      'Supported testing, deployment, and documentation to ensure reliable delivery of new features.'
    ],
    summary: 'Web developer and video editor supporting DOST Region II with dashboard development, data visualization, and multimedia content for public science programs.',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Developed reusable UI components and patterns to improve development speed and consistency.',
      'Integrated REST APIs and third-party services to connect front-end features with backend systems.',
      'Contributed to testing, bug resolution, deployments, and code reviews within an agile team workflow.'
    ],
    summary: 'Front-end developer building scalable web applications with React, Next.js, TypeScript, and Tailwind CSS for cross-functional product teams.',
  ...
  },
  {
    ...
    focusAreas: ['React', 'Tailwind CSS', 'UI Optimization', 'Accessibility'],
    id: 'va4u',
    initials: 'VA',
    isCurrent: false,
    location: 'Remote',
    ...
    responsibilities: [
      ...
      'Collaborated with design and back-end teams to create a consistent and engaging platform.'
    ],
    summary: 'Front-end developer working on the Australian Rewards Club platform with React and Tailwind CSS.',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Applied user-centered design principles to balance usability goals with business requirements.',
      'Maintained consistent, accessible, and on-brand interface patterns across the platform.'
    ],
    summary: 'Front-end developer and UI/UX designer leading product interface work from Figma design through React implementation.',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Planned, created, and published social media content to promote local initiatives and engagement.'
    ],
    summary: 'Administrative and creative support role handling documentation, campaign design, and social media content for community programs.',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Managed social media channels, including content planning, graphics, and community engagement.'
    ],
    summary: 'UI/UX and communications role focused on improving internal system usability and supporting municipal digital content.',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Built practical expertise in React, HTML, CSS, and JavaScript through independent project delivery.'
    ],
    summary: 'Freelance front-end and UI/UX work delivering responsive websites, interface design, and client-facing digital products.',
